...
IF(t1.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne1.`name_element`, 1, 1)),LOWER(SUBSTRING(sne1.`name_element`, 2))),
 IF(t2.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne2.`name_element`, 1, 1)),LOWER(SUBSTRING(sne2.`name_element`, 2))),
  IF(t3.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne3.`name_element`, 1, 1)),LOWER(SUBSTRING(sne3.`name_element`, 2))),
   IF(t4.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne4.`name_element`, 1, 1)),LOWER(SUBSTRING(sne4.`name_element`, 2))),
    IF(t5.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne5.`name_element`, 1, 1)),LOWER(SUBSTRING(sne5.`name_element`, 2))),
     IF(t6.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne6.`name_element`, 1, 1)),LOWER(SUBSTRING(sne6.`name_element`, 2))),
      IF(t7.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne7.`name_element`, 1, 1)),LOWER(SUBSTRING(sne7.`name_element`, 2))),
       IF(t8.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne8.`name_element`, 1, 1)),LOWER(SUBSTRING(sne8.`name_element`, 2))),
        IF(t9.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne9.`name_element`, 1, 1)),LOWER(SUBSTRING(sne9.`name_element`, 2))),
         IF(t10.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne10.`name_element`, 1, 1)),LOWER(SUBSTRING(sne10.`name_element`, 2))),
          IF(t11.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne11.`name_element`, 1, 1)),LOWER(SUBSTRING(sne11.`name_element`, 2))),
           IF(t12.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne12.`name_element`, 1, 1)),LOWER(SUBSTRING(sne12.`name_element`, 2))),
            IF(t13.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne13.`name_element`, 1, 1)),LOWER(SUBSTRING(sne13.`name_element`, 2))),
             IF(t14.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne14.`name_element`, 1, 1)),LOWER(SUBSTRING(sne14.`name_element`, 2))),
              IF(t15.`taxonomic_rank_id` = 83, CONCAT(UCASE(SUBSTRING(sne15.`name_element`, 1, 1)),LOWER(SUBSTRING(sne15.`name_element`, 2))),""
))))))))))))))) AS species_name,
...
IF(t1.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne1.`name_element`, 1, 1)),LOWER(SUBSTRING(sne1.`name_element`, 2))),
 IF(t2.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne2.`name_element`, 1, 1)),LOWER(SUBSTRING(sne2.`name_element`, 2))),
  IF(t3.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne3.`name_element`, 1, 1)),LOWER(SUBSTRING(sne3.`name_element`, 2))),
   IF(t4.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne4.`name_element`, 1, 1)),LOWER(SUBSTRING(sne4.`name_element`, 2))),
    IF(t5.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne5.`name_element`, 1, 1)),LOWER(SUBSTRING(sne5.`name_element`, 2))),
     IF(t6.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne6.`name_element`, 1, 1)),LOWER(SUBSTRING(sne6.`name_element`, 2))),
      IF(t7.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne7.`name_element`, 1, 1)),LOWER(SUBSTRING(sne7.`name_element`, 2))),
       IF(t8.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne8.`name_element`, 1, 1)),LOWER(SUBSTRING(sne8.`name_element`, 2))),
        IF(t9.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne9.`name_element`, 1, 1)),LOWER(SUBSTRING(sne9.`name_element`, 2))),
         IF(t10.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne10.`name_element`, 1, 1)),LOWER(SUBSTRING(sne10.`name_element`, 2))),
          IF(t11.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne11.`name_element`, 1, 1)),LOWER(SUBSTRING(sne11.`name_element`, 2))),
           IF(t12.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne12.`name_element`, 1, 1)),LOWER(SUBSTRING(sne12.`name_element`, 2))),
            IF(t13.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne13.`name_element`, 1, 1)),LOWER(SUBSTRING(sne13.`name_element`, 2))),
             IF(t14.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne14.`name_element`, 1, 1)),LOWER(SUBSTRING(sne14.`name_element`, 2))),
              IF(t15.`taxonomic_rank_id` NOT IN (54,76,6,72,112,17,20,96,83), CONCAT(UCASE(SUBSTRING(sne15.`name_element`, 1, 1)),LOWER(SUBSTRING(sne15.`name_element`, 2))),""
    ...
    sc.`scrutiny_date` AS scrutiny_date,
