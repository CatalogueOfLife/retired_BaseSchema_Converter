...
--
-- Host: localhost
-- Generation Time: Apr 13, 2010 at 11:42 AM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Author citations of taxa and synonyms' AUTO_INCREMENT=27 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Latest scrutiny date of a taxon' AUTO_INCREMENT=11 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Scientific name elements and hierarchy of a taxon' AUTO_INCREMENT=64 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Unique resource identifiers' AUTO_INCREMENT=23 ;
...
ALTER TABLE `common_name`
  ...
  ADD CONSTRAINT `common_name_ibfk_11` FOREIGN KEY (`common_name_element_id`) REFERENCES `common_name_element` (`id`) ON UPDATE CASCADE,
...
ALTER TABLE `distribution`
  ADD CONSTRAINT `distribution_ibfk_3` FOREIGN KEY (`distribution_status_id`) REFERENCES `distribution_status` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `distribution_ibfk_4` FOREIGN KEY (`region_id`) REFERENCES `region` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `distribution_ibfk_5` FOREIGN KEY (`taxon_detail_id`) REFERENCES `taxon_detail` (`taxon_id`) ON UPDATE CASCADE;
...
--
ALTER TABLE `habitat`
  ADD CONSTRAINT `habitat_ibfk_1` FOREIGN KEY (`habitat_standard_id`) REFERENCES `habitat_standard` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `habitat_to_taxon_detail`
--
ALTER TABLE `habitat_to_taxon_detail`
  ADD CONSTRAINT `habitat_to_taxon_detail_ibfk_1` FOREIGN KEY (`habitat_id`) REFERENCES `habitat` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `habitat_to_taxon_detail_ibfk_2` FOREIGN KEY (`taxon_detail_id`) REFERENCES `taxon_detail` (`taxon_id`) ON UPDATE CASCADE;
...
ALTER TABLE `reference_to_synonym`
  ...
  ADD CONSTRAINT `reference_to_synonym_ibfk_6` FOREIGN KEY (`synonym_id`) REFERENCES `synonym` (`id`) ON UPDATE CASCADE;
...
--
ALTER TABLE `synonym`
  ADD CONSTRAINT `synonym_ibfk_11` FOREIGN KEY (`scientific_name_status_id`) REFERENCES `scientific_name_status` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `synonym_ibfk_12` FOREIGN KEY (`author_string_id`) REFERENCES `author_string` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `synonym_ibfk_7` FOREIGN KEY (`taxon_id`) REFERENCES `taxon` (`id`) ON UPDATE CASCADE;
...
ALTER TABLE `taxon`
  ...
  ADD CONSTRAINT `taxon_ibfk_27` FOREIGN KEY (`taxonomic_rank_id`) REFERENCES `taxonomic_rank` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `taxon_detail`
--
ALTER TABLE `taxon_detail`
  ADD CONSTRAINT `taxon_detail_ibfk_10` FOREIGN KEY (`taxon_id`) REFERENCES `taxon` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `taxon_detail_ibfk_7` FOREIGN KEY (`scrutiny_id`) REFERENCES `scrutiny` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `taxon_detail_ibfk_8` FOREIGN KEY (`author_string_id`) REFERENCES `author_string` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `taxon_detail_ibfk_9` FOREIGN KEY (`scientific_name_status_id`) REFERENCES `scientific_name_status` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `taxon_name_element`
--
ALTER TABLE `taxon_name_element`
  ADD CONSTRAINT `taxon_name_element_ibfk_1` FOREIGN KEY (`taxon_id`) REFERENCES `taxon` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `taxon_name_element_ibfk_2` FOREIGN KEY (`scientific_name_element_id`) REFERENCES `scientific_name_element` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `taxon_name_element_ibfk_3` FOREIGN KEY (`parent_id`) REFERENCES `taxon` (`id`) ON UPDATE CASCADE;
